...
/*
        ...
        int Deck::number () const { // Return the number of cards in the deck.
            return cards.size();
        }

        Card &Deck::card (int i) { // Return the content of the card based on the index.
            return cards.at(i);
        }
        ...
        vector<int_pair> Find_match( Deck deck1, Deck deck2){
            ...
            int_pair iter;
            for(int i=0; i<deck1.number(); i++){
                for(int j=0; j<deck2.number(); j++){
